...
namespace ESISharp.Paths.Public
{
    public class Alliance : ApiPath
    {
        ...
        {
            var path = new Path() { "alliances", allianceid.ToString() };
        ...
        {
            var path = new Path() { "alliances", allianceid.ToString(), "corporations" };
            return new EsiRequest(EsiConnection, path, WebMethods.GET);
        }
        ...
        {
            var path = new Path() { "alliances", allianceid.ToString(), "icons" };
            return new EsiRequest(EsiConnection, path, WebMethods.GET);
        }
