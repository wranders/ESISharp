...
namespace ESISharp
{
    ...
    public partial class Sso
    {
        ...
        /// <summary>
        /// Set Application Client ID and Secret Key
        /// </summary>
        /// <param name="AppClientID">(String) Client ID</param>
        /// <param name="AppSecretKey">(String) Secret Key</param>
        ...
        /// <summary>
        /// Set the Callback protocol for the Auth Router
        /// </summary>
        ...
        /// <summary>
        /// Set directory location of the Auth Router application
        /// </summary>
        ...
        /// <summary>
        /// Set the file name of the Auth Router application
        /// </summary>
        ...
        /// <summary>
        /// Set the SSO token Type (Authentication or Implicit)
        /// </summary>
        ...
        /// <summary>
        /// Add multiple Scopes to Request
        /// </summary>
        ...
        /// <summary>
        /// Remove all scopes, Requested and Authorized
        /// </summary>
        ...
        /// <summary>
        /// Get currently Requested Scopes
        /// </summary>
        ...
        /// <summary>
        /// Get the Refresh Token (Only available if using Authorization Grant Type)
        /// </summary>
